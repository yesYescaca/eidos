...
GATE_LIVE_GATE_ONLY_ALIGN = 0.72
GATE_QUESTION_GOAL_CLEAR = 0.78
GATE_LIVE_GATE_ONLY_CLEAR = 0.68
GATE_LLM_RETRY_ATTEMPTS = 3
GATE_LLM_RETRY_BACKOFF_SEC = 2.0

# v7.4: TruthfulQA factual path — commit on clear misconception questions
GATE_TRUTHFULQA_ALIGN = 0.68
